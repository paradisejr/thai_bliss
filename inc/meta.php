...
<head>
    ...
    <!--[if IE]>
        ...
        <script src="js/plugin/bootstrap/bootstrap-select.js"></script>
        <script src="js/plugin/jquery-ui/js/jquery-ui-1.10.3.custom.js"></script>
        ...
        <script src="js/plugin/owl-carousel/owl.carousel.js" type="text/javascript"></script>
